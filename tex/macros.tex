...
\def\haoqi{\includegraphics[width=0.18in]{emoji_haoqi.jpg}}
%% colors
\def\code#1{\noindent\fcolorbox{green}{gray}{#1}}
...
%%control
\def\uline#1{\underline{\ \hspace{#1 in}\ }}
...
\def\ech{\end{CJK}}
\def\bchl{\bch\begin{large}}
\def\echl{\end{large}\ech}
\def\bchL{\bch\begin{Large}}
\def\echL{\end{Large}\ech}
